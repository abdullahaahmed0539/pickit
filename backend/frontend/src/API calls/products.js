...
export const fetchMyProducts = async (userId, pageId, productFilter) => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/users/${userId}/get_products`,
...
export const createProduct = async data => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/create_new`,
    data,
    header
  );
  return response;
...
export const fetchProductDetails = async _id => {
  const response = await axios.get(
    `https://pickitt.herokuapp.com/api/products/${_id}`,
    header
  );
  return response;
};
...
export const updateProduct = async data => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/update`,
    data,
    header
  );
  return response;
...
export const unapprove = async productId => {
  const response = await axios.delete(
    `https://pickitt.herokuapp.com/api/products/${productId}`,
    header
  );
  return response;
};
...
export const fetchPendingProducts = async () => {
  const response = await axios.get(
    `https://pickitt.herokuapp.com/api/products/unapproved`,
    header
  );
...
export const approve = async data => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/approve`,
    data,
    header
  );
  return response;
...
export const getUploadLink = async () => {
  const response = await axios.get(
    `https://pickitt.herokuapp.com/api/products/upload_image`
  );
  return response;
};
...
export const fetchCart = async userId => {
  const response = await axios.get(
    `https://pickitt.herokuapp.com/api/products/cart/${userId}`,
    header
  );
  return response;
};
...
export const addToCart = async productId => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/addToCart/${productId}`,
    {},
    header
  );
  return response;
...
export const removeFromCart = async productId => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/removeFromCart/${productId}`,
    {},
    header
  );
  return response;
...
export const sellProduct = async _id => {
  const response = await axios.post(
    `https://pickitt.herokuapp.com/api/products/sell_product`,
    { _id },
    header
  );
  return response;
...
export const fetchAllExchangable = async () => {
  const response = await axios.get(
    `https://pickitt.herokuapp.com/api/products/fetch_all_exchangable`,
    header
  );
  return response;
};
